____Important note for NYU Prince users:____
____Load all necessary modules via:_________
	source module_load.sh 

erisapfel: a split and discordant derived CNV breakpoint detector for evolved populations.
