...
def load_configuration_file(config_file_name):
    ...
    if resource_dict['filter_chromosome']:
        is_str = resource_dict['filter_chromosome']
        is_str = is_str.strip()
        
        is_list = is_str.split(' ')
        resource_dict['filter_chromosome'] = set(is_list)
...
def io_load(runmode='resource'):
    if runmode == 'resource':
        ...
        resource_dict = pickle_loader(resource_file_name, 'dict')
...
def get_seq(seq_file_name):
    ...
    #seq_file = open('C:/Gresham/tiny_projects/tiny_cvish/temp/test.txt')
    seq_dict = {}
    seq = False
...
if args.call_breakpoints:        
    ...
    resource_dict['hypothesis_dict.p'] = resource_pickle_name
